...
MSG = {"Url":"https://www.profesia.sk/sitemap.php","Selector":"url","Type":"many","Subselectors":[{"Selector":"loc","Attribute":"text","Name":"url","Split":"","Default":""}]}

def call_rpc(message=MSG)
    TCP_IP = '127.0.0.1'
    TCP_PORT = 9000
    BUFFER_SIZE = 2048
